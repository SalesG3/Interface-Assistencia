...
export class RequestService {
  headers = { TOKEN: process.env['TOKEN'] || "", "Content-Type":"application/json"};
  ...
  async dadosGrid(tabela : string, data : object){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/grid/${tabela}`,{
        method: "POST",
  ...
  async codigoAuto( tabela : string){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/codigo/${tabela}`,{
        method: "GET",
        headers: this.headers
      });
  ...
  async novoRegistro( tabela : string, data : object ){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/novo/${tabela}`,{
        method: "POST",
        headers: this.headers,
        body: JSON.stringify(data)
      });
  ...
  async alterarRegistro(tabela : string, data : object, id : number){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/alterar/${tabela}/${id}`,{
        method: "PUT",
        headers: this.headers,
        body: JSON.stringify(data)
      });
  ...
  async consultarRegistro(tabela : string, id : number){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/consulta/${tabela}/${id}`,{
        method: "GET",
        headers: this.headers
      });
  ...
  async excluirRegistro(tabela : string, id : number){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/delete/${tabela}/${id}`,{
        method: "DELETE",
        headers: this.headers
      });
  ...
  async lookupSelect(tabela : string){
    ...
    try{
      let request = await fetch(process.env['APIURL'] + `/lookup/${tabela}`,{
        method: "GET",
        headers: this.headers
      });
